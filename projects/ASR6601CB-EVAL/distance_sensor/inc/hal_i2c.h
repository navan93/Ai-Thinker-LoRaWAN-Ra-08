 ...
 * NOTE: Polling-based
 */
bool hal_i2c_write_addr8_data8(uint8_t addr, uint8_t data);
bool hal_i2c_write_addr8_data16(uint8_t addr, uint16_t data);
bool hal_i2c_write_addr16_data8(uint16_t addr, uint8_t data);
bool hal_i2c_write_addr16_data16(uint16_t addr, uint16_t data);
