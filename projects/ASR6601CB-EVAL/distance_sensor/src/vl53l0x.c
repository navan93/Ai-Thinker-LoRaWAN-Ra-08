...
static bool data_init()
{
    ...
    if (!hal_i2c_read_addr8_data8(REG_VHV_CONFIG_PAD_SCL_SDA_EXTSUP_HV, &vhv_config_scl_sda)) {
        return false;
    }
    vhv_config_scl_sda |= 0x01;
    if (!hal_i2c_write_addr8_data8(REG_VHV_CONFIG_PAD_SCL_SDA_EXTSUP_HV, vhv_config_scl_sda)) {
        return false;
    }

    /* Set I2C standard mode */
    success = hal_i2c_write_addr8_data8(0x88, 0x00);

    success &= hal_i2c_write_addr8_data8(0x80, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x00, 0x00);
    /* It may be unnecessary to retrieve the stop variable for each sensor */
    success &= hal_i2c_read_addr8_data8(0x91, &stop_variable);
    success &= hal_i2c_write_addr8_data8(0x00, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x80, 0x00);
...
static bool read_strobe()
{
    bool success = false;
    uint8_t strobe = 0;
    if (!hal_i2c_write_addr8_data8(0x83, 0x00)) {
        return false;
    }
    do {
        success = hal_i2c_read_addr8_data8(0x83, &strobe);
    } while (success && (strobe == 0));
    if (!success) {
        return false;
    }
    if (!hal_i2c_write_addr8_data8(0x83, 0x01)) {
        return false;
    }
    return true;
}
...
static bool get_spad_info_from_nvm(uint8_t *spad_count, uint8_t *spad_type, uint8_t good_spad_map[6])
{
    ...
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x00, 0x00);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x06);
    success &= hal_i2c_read_addr8_data8(0x83, &tmp_data8);
    success &= hal_i2c_write_addr8_data8(0x83, tmp_data8 | 0x04);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x07);
    success &= hal_i2c_write_addr8_data8(0x81, 0x01);
    success &= hal_i2c_write_addr8_data8(0x80, 0x01);
    if (!success) {
      return false;
    }
    ...
    success &= hal_i2c_write_addr8_data8(0x94, 0x6b);
    if (!success) {
        return false;
    }
    if (!read_strobe()) {
    ...
    success &= hal_i2c_read_addr8_data32(0x90, &tmp_data32);
    if (!success) {
        return false;
    }
    ...
    *spad_type = (tmp_data32 >> 15) & 0x01;
    ...
    if (!hal_i2c_write_addr8_data8(0x94, 0x24)) {
        return false;
    }
    if (!read_strobe()) {
        return false;
    }
    if (!hal_i2c_read_addr8_data32(0x90, &tmp_data32)) {
      return false;
    }
    ...
    if (!hal_i2c_write_addr8_data8(0x94, 0x25)) {
        return false;
    }
    if (!read_strobe()) {
        return false;
    ...
    success &=hal_i2c_write_addr8_data8(0x81, 0x00);
    success &=hal_i2c_write_addr8_data8(0xFF, 0x06);
    success &=hal_i2c_read_addr8_data8(0x83, &tmp_data8);
    success &=hal_i2c_write_addr8_data8(0x83, tmp_data8 & 0xfb);
    success &=hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &=hal_i2c_write_addr8_data8(0x00, 0x01);
    success &=hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &=hal_i2c_write_addr8_data8(0x80, 0x00);
    ...
    if (!hal_i2c_read_addr8_bytes(REG_GLOBAL_CONFIG_SPAD_ENABLES_REF_0, good_spad_map, 6)) {
        return false;
    }
    return success;
}
...
static bool set_spads_from_nvm()
{
    ...
    bool success = hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(REG_DYNAMIC_SPAD_REF_EN_START_OFFSET, 0x00);
    success &= hal_i2c_write_addr8_data8(REG_DYNAMIC_SPAD_NUM_REQUESTED_REF_SPAD, 0x2C);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(REG_GLOBAL_CONFIG_REF_EN_START_SELECT, SPAD_START_SELECT);
    if (!success) {
        return false;
    }
    ...
    if (!hal_i2c_write_addr8_bytes(REG_GLOBAL_CONFIG_SPAD_ENABLES_REF_0, spad_map, SPAD_MAP_ROW_COUNT)) {
        return false;
    }
...
static bool load_default_tuning_settings()
{
    ...
    success &= hal_i2c_write_addr8_data8(0x00, 0x00);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x09, 0x00);
    success &= hal_i2c_write_addr8_data8(0x10, 0x00);
    success &= hal_i2c_write_addr8_data8(0x11, 0x00);
    success &= hal_i2c_write_addr8_data8(0x24, 0x01);
    success &= hal_i2c_write_addr8_data8(0x25, 0xFF);
    success &= hal_i2c_write_addr8_data8(0x75, 0x00);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x4E, 0x2C);
    success &= hal_i2c_write_addr8_data8(0x48, 0x00);
    success &= hal_i2c_write_addr8_data8(0x30, 0x20);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x30, 0x09);
    success &= hal_i2c_write_addr8_data8(0x54, 0x00);
    success &= hal_i2c_write_addr8_data8(0x31, 0x04);
    success &= hal_i2c_write_addr8_data8(0x32, 0x03);
    success &= hal_i2c_write_addr8_data8(0x40, 0x83);
    success &= hal_i2c_write_addr8_data8(0x46, 0x25);
    success &= hal_i2c_write_addr8_data8(0x60, 0x00);
    success &= hal_i2c_write_addr8_data8(0x27, 0x00);
    success &= hal_i2c_write_addr8_data8(0x50, 0x06);
    success &= hal_i2c_write_addr8_data8(0x51, 0x00);
    success &= hal_i2c_write_addr8_data8(0x52, 0x96);
    success &= hal_i2c_write_addr8_data8(0x56, 0x08);
    success &= hal_i2c_write_addr8_data8(0x57, 0x30);
    success &= hal_i2c_write_addr8_data8(0x61, 0x00);
    success &= hal_i2c_write_addr8_data8(0x62, 0x00);
    success &= hal_i2c_write_addr8_data8(0x64, 0x00);
    success &= hal_i2c_write_addr8_data8(0x65, 0x00);
    success &= hal_i2c_write_addr8_data8(0x66, 0xA0);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x22, 0x32);
    success &= hal_i2c_write_addr8_data8(0x47, 0x14);
    success &= hal_i2c_write_addr8_data8(0x49, 0xFF);
    success &= hal_i2c_write_addr8_data8(0x4A, 0x00);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x7A, 0x0A);
    success &= hal_i2c_write_addr8_data8(0x7B, 0x00);
    success &= hal_i2c_write_addr8_data8(0x78, 0x21);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x23, 0x34);
    success &= hal_i2c_write_addr8_data8(0x42, 0x00);
    success &= hal_i2c_write_addr8_data8(0x44, 0xFF);
    success &= hal_i2c_write_addr8_data8(0x45, 0x26);
    success &= hal_i2c_write_addr8_data8(0x46, 0x05);
    success &= hal_i2c_write_addr8_data8(0x40, 0x40);
    success &= hal_i2c_write_addr8_data8(0x0E, 0x06);
    success &= hal_i2c_write_addr8_data8(0x20, 0x1A);
    success &= hal_i2c_write_addr8_data8(0x43, 0x40);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x34, 0x03);
    success &= hal_i2c_write_addr8_data8(0x35, 0x44);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x31, 0x04);
    success &= hal_i2c_write_addr8_data8(0x4B, 0x09);
    success &= hal_i2c_write_addr8_data8(0x4C, 0x05);
    success &= hal_i2c_write_addr8_data8(0x4D, 0x04);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x44, 0x00);
    success &= hal_i2c_write_addr8_data8(0x45, 0x20);
    success &= hal_i2c_write_addr8_data8(0x47, 0x08);
    success &= hal_i2c_write_addr8_data8(0x48, 0x28);
    success &= hal_i2c_write_addr8_data8(0x67, 0x00);
    success &= hal_i2c_write_addr8_data8(0x70, 0x04);
    success &= hal_i2c_write_addr8_data8(0x71, 0x01);
    success &= hal_i2c_write_addr8_data8(0x72, 0xFE);
    success &= hal_i2c_write_addr8_data8(0x76, 0x00);
    success &= hal_i2c_write_addr8_data8(0x77, 0x00);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x0D, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x80, 0x01);
    success &= hal_i2c_write_addr8_data8(0x01, 0xF8);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x8E, 0x01);
    success &= hal_i2c_write_addr8_data8(0x00, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x80, 0x00);
    return success;
...
static bool configure_interrupt()
{
    ...
    if (!hal_i2c_write_addr8_data8(REG_SYSTEM_INTERRUPT_CONFIG_GPIO, 0x04)) {
        return false;
    }

    /* Configure active low since the pin is pulled-up on most breakout boards */
    uint8_t gpio_hv_mux_active_high = 0;
    if (!hal_i2c_read_addr8_data8(REG_GPIO_HV_MUX_ACTIVE_HIGH, &gpio_hv_mux_active_high)) {
        return false;
    }
    gpio_hv_mux_active_high &= ~0x10;
    if (!hal_i2c_write_addr8_data8(REG_GPIO_HV_MUX_ACTIVE_HIGH, gpio_hv_mux_active_high)) {
        return false;
    }

    if (!hal_i2c_write_addr8_data8(REG_SYSTEM_INTERRUPT_CLEAR, 0x01)) {
        return false;
    }
    return true;
}
...
{
    return hal_i2c_write_addr8_data8(REG_SYSTEM_SEQUENCE_CONFIG, sequence_step);
}
...
static bool perform_single_ref_calibration(calibration_type_t calib_type)
{
    ...
    if (!hal_i2c_write_addr8_data8(REG_SYSTEM_SEQUENCE_CONFIG, sequence_config)) {
        return false;
    }
    if (!hal_i2c_write_addr8_data8(REG_SYSRANGE_START, sysrange_start)) {
        return false;
    }
    /* Wait for interrupt */
    ...
    bool success = false;
    do {
        success = hal_i2c_read_addr8_data8(REG_RESULT_INTERRUPT_STATUS, &interrupt_status);
    ...
    if (!hal_i2c_write_addr8_data8(REG_SYSRANGE_START, 0x00)) {
        return false;
    }
    return true;
}
...
{
    uint8_t device_id = 0;
    if (!hal_i2c_read_addr8_data8(REG_IDENTIFICATION_MODEL_ID, &device_id)) {
        return false;
    }
...
{
    /* 7-bit address */
    return hal_i2c_write_addr8_data8(REG_SLAVE_DEVICE_ADDRESS, addr & 0x7F);
}
...
{
    hal_gpio_set_output(vl53l0x_infos[idx].xshut_gpio, !enable);
}
...
{
    hal_gpio_init();
    hal_gpio_set_output(GPIO_XSHUT_FIRST, false);
    hal_gpio_set_output(GPIO_XSHUT_SECOND, false);
    hal_gpio_set_output(GPIO_XSHUT_THIRD, false);
}
...
static bool init_address(vl53l0x_idx_t idx)
{
    ...
    hal_i2c_set_slave_address(VL53L0X_DEFAULT_ADDRESS);
...
{
    // hal_i2c_set_slave_address(vl53l0x_infos[idx].addr);
    if (!data_init()) {
        return false;
    }
    if (!static_init()) {
...
{
    // hal_i2c_set_slave_address(vl53l0x_infos[idx].addr);
    bool success = hal_i2c_write_addr8_data8(0x80, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x01);
    success &= hal_i2c_write_addr8_data8(0x00, 0x00);
    success &= hal_i2c_write_addr8_data8(0x91, stop_variable);
    success &= hal_i2c_write_addr8_data8(0x00, 0x01);
    success &= hal_i2c_write_addr8_data8(0xFF, 0x00);
    success &= hal_i2c_write_addr8_data8(0x80, 0x00);
    if (!success) {
    ...
    if (!hal_i2c_write_addr8_data8(REG_SYSRANGE_START, 0x01)) {
        return false;
    }

    uint8_t sysrange_start = 0;
    do {
        success = hal_i2c_read_addr8_data8(REG_SYSRANGE_START, &sysrange_start);
    ...
    if (!hal_i2c_read_addr8_data16(REG_RESULT_RANGE_STATUS + 10, range)) {
        return false;
    }
